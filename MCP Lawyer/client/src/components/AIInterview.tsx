...
export default function AIInterview({ onComplete }: AIInterviewProps) {
  ...
  const createSessionMutation = useMutation({
    mutationFn: ({ practiceArea, caseType }: { practiceArea: string, caseType?: string }) => 
      createInterviewSession(practiceArea, caseType),
    onSuccess: (data) => {
  ...
  const completeInterviewMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      setCaseAssessment(data.caseAssessment)
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      {caseAssessment.estimatedCosts.range && (
                        <p><strong>Range:</strong> {caseAssessment.estimatedCosts.range}</p>
                      )}
